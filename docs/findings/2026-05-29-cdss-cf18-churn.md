...
evidence:
  - kind: dataset
    ...
    note: "Source: `cdss.ca.gov` DSSDS Tables CF18 series (CF18FY23-24, CF18FY24-25, CF18FY25-26 xlsx). Public CA state data. Statewide rows extracted; rates computed from cells 1/2/15/16."
  - kind: file
