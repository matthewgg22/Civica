...
IA, AR, MS, NM, NE, DE, SD, ND. The individual tier (§6 step 3) is CLOSED at 13/13;
CT/UT/IA/AR (first batch-tier segment), MS/NM/NE (second batch-tier segment), and
DE/SD/ND (fifth batch-tier segment) are all now DONE, built and merged as one batch each
...
genuinely-indeterminate profiles, see below) for **36 of those 44**: CA, WA, TX, GA, MI,
IL, FL, MA, NV, OR, WI, KS, OH, AK, NC, VA, IN, MO, MD, CO, SC, LA, OK, ME, RI, MT, KY,
IA, AR, NM, NE, SD, ND clear CLEAN (129/0/0); NY (127/2/0), AZ (128/1/0), and CT (128/1/0)
are documented pre-existing partials in the same "clean" bucket — CT's single disclosed
fail is the SAME #830 architecture-gap shape as NY's/AZ's, not a coverage gap. PA, NJ, TN,
AL, UT, MS, and DE also have all 92 (or 89, for TN) rows authored, per the execution log's
entries below, but all seven grade 34/0/95 — most of their profiles legitimately SKIP on
...
to carry this null-SUA shape — PA/NJ/TN/AL/UT are all BBCE states; DE followed.)
...
DC, GU, HI, ID, NH,
VI, VT, WV, WY. (NC, NJ, VA, TN, IN, MO, MD, CO, SC, LA, OK, AL, and KY — all thirteen
...
MS, NM, NE (second batch-tier group), and DE, SD, ND (fifth batch-tier group) are all
DONE (execution log's entries below). ID/WV/NH — the only batch-tier segment still
awaiting merge — was concurrently in flight as of this build, not yet merged; not read
or coordinated with. VT/WY/DC and VI remain unstarted-by-this-build.)
...
6. Batch tier (<4M population, N≤3 per batch): ~~CT, UT, IA, AR~~ (done — first batch-tier
   ...
   entries) / ~~DE, SD, ND~~ (done — fifth batch-tier segment, see the execution log's
   DE/SD/ND entries) / VT, WY, DC / VI (built, PR #859 open, filed #858 — none of
   ID/WV/NH, VT/WY/DC, or VI is merged yet; all were concurrently in flight as of this
   build, not read or coordinated with).
