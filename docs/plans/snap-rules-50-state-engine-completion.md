...
states.ts`) exists for **38 states**: CA, WA, TX, NY, GA, MI, IL, FL, MA, NV, AZ, OR, WI,
MN, OH, KS, PA, AK, NC, NJ, VA, TN, IN, MO, MD, CO, SC, LA, OK, ME, RI, MT, AL, KY, CT, UT,
IA, AR. The individual tier (§6 step 3) is CLOSED at 13/13; CT/UT/IA/AR is this plan's
first BATCH-TIER segment (§6 step 6), built and merged as one batch per the execution
log's CT/UT/IA/AR entries below.
...
genuinely-indeterminate profiles, see below) for **32 of those 38**: CA, WA, TX, GA, MI,
IL, FL, MA, NV, OR, WI, KS, OH, AK, NC, VA, IN, MO, MD, CO, SC, LA, OK, ME, RI, MT, KY,
IA, AR clear CLEAN (129/0/0); NY (127/2/0), AZ (128/1/0), and CT (128/1/0) are documented
pre-existing partials in the same "clean" bucket — CT's single disclosed fail is the SAME
#830 architecture-gap shape as NY's/AZ's, not a coverage gap. PA, NJ, TN, AL, and UT also
have all 92 (or 89, for TN) rows authored, per the execution log's PA/NJ/TN/AL/UT entries
below, but all five grade 34/0/95 — most of their profiles legitimately SKIP on the
null-SUA gap, not a coverage gap, so none is counted as "clean" here. (AL's own oracle
...
coverage and a clean harness grade are different things.)
...
**15 states have neither** `StatePolicy` nor oracle coverage — the full remaining scope:
DC, DE, GU, HI, ID, MS, ND, NE, NH,
NM, SD, VI, VT, WV, WY. (NC, NJ, VA, TN, IN, MO, MD, CO, SC, LA, OK, AL, and KY — all
...
13/13.** ME, RI, and MT — the fourth batch-tier group — are DONE (execution log's
ME/RI/MT entries). CT, UT, IA, and AR — the first batch-tier group, §6 step 6 — are ALSO
now DONE; see the execution log's CT/UT/IA/AR entries below. MS/NM/NE and ID/WV/NH — the
other two remaining batch-tier segments — were concurrently in flight as of this build,
none yet merged; not read or coordinated with.)
...
6. Batch tier (<4M population, N≤3 per batch): ~~CT, UT, IA, AR~~ (done — first batch-tier
   ...
   entries) / DE, SD, ND / VT, WY, DC / VI (built, PR #859 open, filed #858 — none of
   MS/NM/NE, ID/WV/NH, DE/SD/ND, VT/WY/DC, or VI is merged yet; all were concurrently in
