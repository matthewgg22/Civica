...
export const FRONTDOOR_EVAL: FrontDoorCase[] = [
  ...
  // Arizona — 8th verified state (docs/plans/mae-state-corpus-framework.md, Wave 2).
  { id: "az-program-name", category: "AZ", question: "What agency runs SNAP in Arizona and where do I apply?", expect: { kind: "external", citation: "CNAP FAA2.A.01" }, state: "AZ" },
  { id: "az-income-limit", category: "AZ", question: "What's the income limit for SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA6.J.02.B.04" }, state: "AZ" },
  { id: "az-expanded-cat-elig", category: "AZ", question: "Is there a higher income limit for SNAP in Arizona if I'm categorically eligible?", expect: { kind: "external", citation: "CNAP FAA5.I.01.B" }, state: "AZ" },
  { id: "az-asset-limit", category: "AZ", question: "Is there an asset or savings limit for SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA6.J.06.B" }, state: "AZ" },
  { id: "az-vehicle", category: "AZ", question: "Does my car count against me for SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA4.C.01" }, state: "AZ" },
  { id: "az-sua", category: "AZ", question: "What's the utility allowance for SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA6.J.09" }, state: "AZ" },
  { id: "az-medical-deduction", category: "AZ", question: "Is there a standard medical deduction for seniors on SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA5.I.03.E" }, state: "AZ" },
  { id: "az-child-support", category: "AZ", question: "Does paying child support lower my countable income for SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA5.I.03.C" }, state: "AZ" },
  { id: "az-abawd-clock", category: "AZ", question: "What is the current three-year ABAWD time limit window in Arizona?", expect: { kind: "external", citation: "CNAP FAA2.M.09.A" }, state: "AZ" },
  { id: "az-drug-felony", category: "AZ", question: "I have a drug felony conviction — can I still get SNAP in Arizona?", expect: { kind: "external", citation: "CNAP FAA2.A.09" }, state: "AZ" },
  { id: "az-expedited", category: "AZ", question: "How fast can I get emergency SNAP benefits in Arizona?", expect: { kind: "external", citation: "CNAP FAA2.A.03" }, state: "AZ" },
