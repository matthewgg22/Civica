...
import hiPack from "./hi/pack.json";
...
import mtPack from "./mt/pack.json";
import mtSupplements from "./mt/supplements.json";
import mtAuthorities from "./mt/authorities.json";
import mtFreshness from "./mt/freshness.json";
...
import ndPack from "./nd/pack.json";
...
import wyPack from "./wy/pack.json";
import wySupplements from "./wy/supplements.json";
import wyAuthorities from "./wy/authorities.json";
import wyFreshness from "./wy/freshness.json";
import vtPack from "./vt/pack.json";
import vtSupplements from "./vt/supplements.json";
import vtAuthorities from "./vt/authorities.json";
import vtFreshness from "./vt/freshness.json";
import dcPack from "./dc/pack.json";
import dcSupplements from "./dc/supplements.json";
import dcAuthorities from "./dc/authorities.json";
import dcFreshness from "./dc/freshness.json";
...
export type StateCode = "CA" | "WA" | "TX" | "NY" | "GA" | "MI" | "IL" | "FL" | "MA" | "NV" | "AZ" | "OR" | "WI" | "MN" | "PA" | "OH" | "NC" | "NJ" | "VA" | "TN" | "IN" | "MO" | "MD" | "CO" | "SC" | "AL" | "LA" | "KY" | "OK" | "CT" | "UT" | "IA" | "AR" | "MS" | "KS" | "NM" | "NE" | "ID" | "WV" | "HI" | "ME" | "NH" | "SD" | "MT" | "RI" | "ND" | "DE" | "WY" | "VT" | "DC" | "VI";
...
const REGISTRY: Record<StateCode, StatePack> = {
  ...
  HI: buildPack(
    hiPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
  ...
  MT: buildPack(
    mtPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
    mtSupplements as { supplements: PackTopic[]; supersessions?: Record<string, string> },
    mtAuthorities as unknown as RawAuthorities,
    mtFreshness as { entries: PackFreshnessEntry[] },
  ),
  RI: buildPack(
    riPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
    riSupplements as { supplements: PackTopic[]; supersessions?: Record<string, string> },
    riAuthorities as unknown as RawAuthorities,
    riFreshness as { entries: PackFreshnessEntry[] },
  ),
  ND: buildPack(
    ndPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
  ...
  WY: buildPack(
    wyPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
    wySupplements as { supplements: PackTopic[]; supersessions?: Record<string, string> },
    wyAuthorities as unknown as RawAuthorities,
    wyFreshness as { entries: PackFreshnessEntry[] },
  ),
  VT: buildPack(
    vtPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
    vtSupplements as { supplements: PackTopic[]; supersessions?: Record<string, string> },
    vtAuthorities as unknown as RawAuthorities,
    vtFreshness as { entries: PackFreshnessEntry[] },
  ),
  DC: buildPack(
    dcPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
    dcSupplements as { supplements: PackTopic[]; supersessions?: Record<string, string> },
    dcAuthorities as unknown as RawAuthorities,
    dcFreshness as { entries: PackFreshnessEntry[] },
  ),
  VI: buildPack(
    usviPack as Omit<StatePack, "topics" | "authorities" | "freshness" | "supersessions">,
    usviSupplements as { supplements: PackTopic[]; supersessions?: Record<string, string> },
    usviAuthorities as unknown as RawAuthorities,
    usviFreshness as { entries: PackFreshnessEntry[] },
  ),
};
