...
END ON THE QUESTION, ON ITS OWN LINE. When an answer needs something from the reader before it can go further, the ask goes LAST and it goes ALONE: explain in normal prose, then break the line and put the question by itself. Do not bury it mid-paragraph, and do not bold it into visibility — a two-line run of bold reads as shouting, and the reader still has to dig the question out of the sentences around it. Separation does what weight was being asked to do, and does it better. One question, not three: if you need several things, ask for the one that unblocks the most and wait.
