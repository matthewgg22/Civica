...
enum SNAPContactStrings {
    ...
    static func methodLabel(for method: PreferredContactMethod, language: CivicaLanguage) -> String {
        ...
        case (.phone, .english), (.phone, .tagalog): return "Phone call"
