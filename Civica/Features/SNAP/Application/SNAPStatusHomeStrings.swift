...
enum SNAPStatusHomeStrings {
    ...
    static let returningSubtitle = CivicaText(
        ...
        tl: "Narito ang kalagayan ng iyong SNAP application."
    )
    static let returningResume = CivicaText(
        ...
        tl: "Ituloy kung saan ka huminto"
    )
    ...
    static func waitingBody(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog:
            return "Nasa \(agency) na ang iyong application. Karamihan ng desisyon ay umaabot ng 7–30 araw. Aabisuhan ka namin kapag may nagbago."
        }
    }
    ...
    static let actionGeneratePacket = CivicaText(
        ...
        tl: "Gawin ang iyong application packet"
    )
    ...
    static func actionSubmitToState(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog: return "Buksan ang \(portalLabel) para i-submit"
        }
    }
    static let actionUploadRequested = CivicaText(
        ...
        tl: "I-upload ang mga hinihinging dokumento"
    )
    ...
    static let actionRecert = CivicaText(
        ...
        tl: "Simulan ang iyong recertification"
    )
    ...
    static let stepScreener = CivicaText(
        ...
        tl: "Screener ng pagiging kuwalipikado"
    )
    static let stepPacket = CivicaText(
        ...
        tl: "Nagawa na ang application packet"
    )
    ...
    static let stepStateAcknowledged = CivicaText(
        ...
        tl: "Natanggap ng estado ang iyong application"
    )
    ...
    static let statusComplete = CivicaText("Complete", es: "Completado", zh: "已完成", vi: "Hoàn tất", tl: "Tapos na")
    static let statusInProgress = CivicaText("In progress", es: "En curso", zh: "进行中", vi: "Đang tiến hành", tl: "Kasalukuyang ginagawa")
    static let statusActionNeeded = CivicaText("Action needed", es: "Acción necesaria", zh: "需要处理", vi: "Cần xử lý", tl: "May kailangang gawin")
    static let statusWaiting = CivicaText("Waiting", es: "En espera", zh: "等待中", vi: "Đang chờ", tl: "Naghihintay")
    ...
    static let deniedTitle = CivicaText(
        ...
        tl: "Tinanggihan ang iyong SNAP application"
    )
    static func deniedBody(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog:
            return "Napagdesisyunan ng \(agency) na hindi ka kuwalipikado ngayon. May mga opsyon ka — hindi katapusan ng lahat ang pagtanggi."
        }
    }
    static let deniedReasonHeading = CivicaText(
        ...
        tl: "Ang sinabi sa amin ng estado"
    )
    static func deniedReasonMissing(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog:
            return "Hindi pa ibinabahagi ng estado ang tiyak na dahilan sa Civica. Tingnan ang iyong \(portalRef) inbox o ang denial notice na natanggap mo sa koreo."
        }
    }
    ...
    static let deniedNextStepsHeading = CivicaText(
        ...
        tl: "Ano ang puwede mong gawin ngayon"
    )
    ...
    static let deniedAppealBody = CivicaText(
        ...
        tl: "Binibigyan ka ng batas pederal ng 90 araw mula sa denial notice para humiling ng fair hearing. Isumite ang iyong appeal bago ang deadline sa iyong denial letter — ang kalalabasan ay depende sa dahilan ng pagtanggi."
    )
    ...
    static let deniedReviewBody = CivicaText(
        ...
        tl: "Minsan ang pagtanggi ay dahil sa nawawalang dokumento o numerong mukhang mali. Tingnan ang iyong application bago ka mag-appeal."
    )
    ...
    static let deniedFoodHelpTitle = CivicaText(
        ...
        tl: "Maghanap ng tulong sa pagkain ngayon"
    )
    static let deniedFoodHelpBody = CivicaText(
        ...
        tl: "Ang mga food bank, school meal program, at community fridge ay hindi nangangailangan ng SNAP approval. Karamihan ay bukas para sa sinumang nangangailangan."
    )
    ...
    static let deniedReapplyTitle = CivicaText(
        ...
        tl: "Mag-apply ulit kapag may nagbago"
    )
    static let deniedReapplyBody = CivicaText(
        ...
        tl: "Kung bumaba ang iyong kita, lumaki ang iyong sambahayan, o tumaas ang iyong mga gastos, puwede kang mag-apply ulit agad. Walang panahon ng paghihintay."
    )
    ...
    static let deniedSecondaryActionReapply = CivicaText(
        ...
        zh: "开始新的申请",
        vi: "Bắt đầu đơn mới",
        tl: "Magsimula ng bagong application"
    )
    ...
    static let deniedReapplyConfirmBody = CivicaText(
        ...
        tl: "Mabubura ang iyong mga naunang sagot. Puwede mong ituloy ang appeal anumang oras bago ang 90-araw na deadline."
    )
    ...
    static let deniedReviewPacketBody = CivicaText(
        ...
        tl: "Isang read-only na kopya ng application na ibinigay ng Civica sa county. Walang puwedeng baguhin dito — kapag handa ka nang magpadala ng bago, i-tap ang nasa ibaba."
    )
    static let deniedReviewReapplyCTA = CivicaText(
        ...
        tl: "Mag-apply ulit gamit ang mga sagot na ito"
    )
    ...
    static let deniedAppealWindowClosed = CivicaText(
        ...
        tl: "Sarado na ang 90-araw na panahon para sa appeal."
    )
    static let deniedAppealCategoryExcluded = CivicaText(
        ...
        tl: "Ang ganitong uri ng pagtanggi ay hindi puwedeng i-appeal sa pamamagitan ng fair hearing."
    )
    ...
    static let deniedPrimaryActionNavigator = CivicaText(
        ...
        tl: "Makipag-usap sa isang navigator"
    )
    ...
    static let recertTitle = CivicaText(
        ...
        tl: "Oras na para i-recertify ang iyong SNAP"
    )
    static func recertBody(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        default:
            ...
            case .tagalog: stateName = "ang iyong estado"
        ...
        case .tagalog:
            return "Ang recertification ay kung paano sinusuri ng \(stateName) na kuwalipikado ka pa rin. Parang nag-aapply ulit lang — pamilyar sa iyo ang karamihan ng mga tanong."
        }
    }
    ...
    static func recertDueLine(formattedDate: String, language: CivicaLanguage) -> String {
        ...
        case .tagalog: return "Dapat bago ang \(formattedDate)"
        }
    }
    ...
    static let recertWhyMattersBody = CivicaText(
        ...
        tl: "Kung malampasan mo ang deadline, hihinto ang iyong benepisyo sa huling araw ng buwan. Kailangan mong mag-apply mula sa simula para makuha itong muli."
    )
    ...
    static let recertNeedIncome = CivicaText(
        ...
        tl: "Mga kamakailang paystub o patunay ng kita"
    )
    static let recertNeedHousehold = CivicaText(
        ...
        tl: "Sinumang sumama o umalis sa sambahayan"
    )
    static let recertNeedExpenses = CivicaText(
        ...
        tl: "Na-update na upa, utilities, o gastos sa medikal"
    )
    static let recertNeedAddress = CivicaText(
        ...
        tl: "Patunay ng tirahan kung lumipat ka"
    )
    ...
    static func recertSecondaryOpenPortal(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog: return "Buksan ang \(portalLabel)"
        }
    }
    ...
    static let findHelpFoodLinkTitle = CivicaText(
        ...
        tl: "Tingnan ang tulong sa pagkain sa mapa"
    )
    static let findHelpFoodLinkSubtitle = CivicaText(
        ...
        tl: "Mga food bank, pantry, at community fridge malapit sa iyo. Hindi kailangan ng SNAP approval."
    )
    ...
    static let findHelpApplicationLinkTitle = CivicaText(
        ...
        tl: "Kumuha ng tulong sa iyong application"
    )
    static let findHelpApplicationLinkSubtitle = CivicaText(
        ...
        tl: "Mga lokal na SNAP navigator at organisasyon sa komunidad na makakatulong nang personal o sa telepono."
    )
}
