...
enum SNAPPacketPDFStrings {
    ...
    static func subtitle(formattedDate: String, language: CivicaLanguage) -> String {
        switch language {
        case .english, .tagalog: return "Prepared on \(formattedDate)"
    ...
    static func disclosure(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        if portal.isEmpty {
            switch language {
            case .english, .tagalog: portalRef = "your state SNAP portal"
    ...
    static func rulesLine(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        switch language {
        case .english, .tagalog: return "Civica · local v1 · FY26 federal poverty guidelines · \(state) BBCE 200%"
