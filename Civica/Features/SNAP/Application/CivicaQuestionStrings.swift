...
enum CivicaQuestionStrings {
    ...
    static let continueLabel = CivicaText("Continue", es: "Continuar", zh: "继续", vi: "Tiếp tục")
    static let closeLabel = CivicaText("Close", es: "Cerrar", zh: "关闭", vi: "Đóng")
    static let backLabel = CivicaText("Back", es: "Atrás", zh: "返回", vi: "Quay lại")
    static let skipLabel = CivicaText("Skip for now", es: "Omitir por ahora", zh: "暂时跳过", vi: "Bỏ qua bây giờ")
    static let notSureLabel = CivicaText("I'm not sure", es: "No estoy seguro", zh: "我不确定", vi: "Tôi không chắc")
    static let yesLabel = CivicaText("Yes", es: "Sí", zh: "是", vi: "Có")
    static let noLabel = CivicaText("No", es: "No", zh: "否", vi: "Không")
    ...
    /// etc.).
    static let amountPlaceholder = CivicaText("Amount", es: "Cantidad", zh: "金额", vi: "Số tiền")
    ...
    static func progressLabel(current: Int, total: Int, language: CivicaLanguage) -> String {
        switch language {
        case .english, .tagalog: return "\(current) of \(total)"
    ...
    static func sectionLabel(index: Int, count: Int, title: String?, language: CivicaLanguage) -> String {
        let prefix: String
        switch language {
        case .english, .tagalog: prefix = "Section \(index) of \(count)"
