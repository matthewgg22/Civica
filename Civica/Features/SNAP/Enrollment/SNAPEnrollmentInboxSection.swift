...
private enum Strings {
    static let sectionTitle = CivicaText("From your navigator", es: "De tu navigator")
    static let loading      = CivicaText("Checking for messages…", es: "Buscando mensajes…")
    static let resolvedA11y = CivicaText("Resolved", es: "Resuelto")
    static let pendingA11y  = CivicaText("Action needed", es: "Acción requerida")
}
