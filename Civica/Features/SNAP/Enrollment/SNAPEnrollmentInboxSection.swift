...
private enum Strings {
    static let sectionTitle = CivicaText("From your navigator", es: "De tu navigator", zh: "来自你的 navigator")
    static let loading      = CivicaText("Checking for messages…", es: "Buscando mensajes…", zh: "正在查看消息…")
    static let resolvedA11y = CivicaText("Resolved", es: "Resuelto", zh: "已解决")
    static let pendingA11y  = CivicaText("Action needed", es: "Acción requerida", zh: "需要处理")
}
