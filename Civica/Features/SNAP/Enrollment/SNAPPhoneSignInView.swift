...
struct SNAPPhoneSignInView: View {
    ...
    private enum Strings {
        static let navTitle = CivicaText("Verify identity", es: "Verificar identidad", zh: "验证身份", vi: "Xác minh danh tính")
        static let cancel = CivicaText("Cancel", es: "Cancelar", zh: "取消", vi: "Hủy")
        static let title = CivicaText("Save your application", es: "Guarda tu solicitud", zh: "保存你的申请", vi: "Lưu đơn của bạn")
        ...
        static let phoneLabel = CivicaText("Phone number", es: "Número de teléfono", zh: "手机号码", vi: "Số điện thoại")
        static let phonePlaceholder = CivicaText("+1 (555) 000-0000", es: "+1 (555) 000-0000", zh: "+1 (555) 000-0000", vi: "+1 (555) 000-0000")
        static let sendCode = CivicaText("Send code", es: "Enviar código", zh: "发送验证码", vi: "Gửi mã")
        ...
        static let otpLabel = CivicaText("Verification code", es: "Código de verificación", zh: "验证码", vi: "Mã xác minh")
        static let otpPlaceholder = CivicaText("6-digit code", es: "Código de 6 dígitos", zh: "6 位验证码", vi: "Mã gồm 6 chữ số")
        static let verify = CivicaText("Verify", es: "Verificar", zh: "验证", vi: "Xác minh")
        static let resend = CivicaText("Send again", es: "Enviar de nuevo", zh: "重新发送", vi: "Gửi lại")
