...
enum SNAPRecoveryStrings {
    ...
    static let entryLinkTitle = CivicaText(
        ...
        tl: "Ipagpatuloy ang naunang aplikasyon"
    )
    static let entryLinkSubtitle = CivicaText(
        ...
        tl: "Nagpalit ka ba ng telepono o ni-reinstall ang app? Bumalik gamit ang one-time code."
    )
    ...
    static let channelHelper = CivicaText(
        ...
        tl: "Magpapadala kami ng one-time code sa telepono o email na ginamit mo nang sinimulan mo ang aplikasyon mo."
    )
    static let channelOptionPhone = CivicaText(
        "Text my phone",
        es: "Enviar un mensaje al teléfono",
        vi: "Nhắn tin đến điện thoại của tôi",
        tl: "I-text ang telepono ko"
    )
    ...
    static let contactHelperPhone = CivicaText(
        ...
        tl: "Maaaring may standard na bayad sa text. Hindi namin kailanman ibinabahagi ang numero mo."
    )
    static let contactHelperEmail = CivicaText(
        ...
        tl: "Gagamitin lang namin ito para ipadala ang code. Hindi namin kailanman ibinabahagi ang email mo."
    )
    ...
    static func codeHelper(contact: String, isPhone: Bool, language: CivicaLanguage) -> String {
        ...
        case (.tagalog, true):   return "Nag-text kami ng code sa \(contact). Dapat dumating ito sa loob ng isang minuto."
        case (.tagalog, false):  return "Nag-email kami sa \(contact). Dapat dumating ang code sa loob ng isang minuto."
    ...
    static let codeResend = CivicaText(
        ...
        vi: "Gửi lại mã",
        tl: "Ipadala ulit ang code"
    )

    // MARK: - Network / error states

    static let sending = CivicaText("Sending…", es: "Enviando…", vi: "Đang gửi…", tl: "Ipinapadala…")
    static let redeeming = CivicaText(
        "Finding your application…",
        es: "Buscando tu solicitud…",
        vi: "Đang tìm đơn đăng ký của bạn…",
        tl: "Hinahanap ang aplikasyon mo…"
    )
    static let sendErrorGeneric = CivicaText(
        ...
        tl: "Hindi namin maipadala ang code ngayon. Subukan ulit mamaya."
    )
    static let redeemErrorBadCode = CivicaText(
        ...
        tl: "Hindi tugma ang code na iyon. I-double check ang mga digit o humingi ng bago."
    )
}