...
enum SNAPBenefitEstimatorStrings {
    ...
    static let pageTitle = CivicaText(
        ...
        tl: "Tantyahin ang benepisyo ng SNAP"
    )
    ...
    static let householdSizeQuestion = CivicaText(
        ...
        tl: "Ilang tao ang nasa iyong sambahayan?"
    )
    static let householdSizeHelper = CivicaText(
        ...
        tl: "Bilangin lahat ng kasama mong bumibili at nagluluto ng pagkain."
    )
    static let householdDecreaseLabel = CivicaText(
        ...
        tl: "Mag-alis ng tao sa sambahayan"
    )
    static let householdIncreaseLabel = CivicaText(
        ...
        tl: "Magdagdag ng tao sa sambahayan"
    )
    ...
    static let elderlyOrDisabledHelper = CivicaText(
        ...
        tl: "Nagbubukas ng dagdag na SNAP deductions, kasama ang walang-takdang gastos sa tirahan."
    )
    ...
    static let incomeQuestion = CivicaText(
        ...
        tl: "Buwanang kita ng sambahayan bago ang buwis"
    )
    static let incomeHelper = CivicaText(
        ...
        tl: "Pagsamahin lahat ng sahod, gig work, unemployment, Social Security, at child support."
    )
    ...
    static let rentHelper = CivicaText(
        ...
        tl: "Ilagay ang aktwal mong binabayaran kada buwan — ang parte mo lang kung hinahati ninyo."
    )
    ...
    static let utilitiesQuestion = CivicaText(
        ...
        tl: "Hiwalay bang bayad ang utilities?"
    )

    // MARK: - Yes / No toggle

    static let toggleYes = CivicaText("Yes", es: "Sí", zh: "是", vi: "Có", tl: "Oo")
    static let toggleNo = CivicaText("No", es: "No", zh: "否", vi: "Không", tl: "Hindi")
    ...
    static let resultEyebrow = CivicaText(
        ...
        tl: "Tinatayang buwanang benepisyo"
    )
    ...
    static func resultContextEligible(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog:
            return "Tantya lang ito — susuriin ng \(agency) ang buo mong aplikasyon at kukumpirmahin ang halaga."
        }
    }
    ...
    static func resultContextMinBenefit(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog:
            return "Sa ilalim ng pederal na batas, karamihan ng 1–2 tao na sambahayan ay nakakatanggap ng kahit $24/buwan kapag naaprubahan. Kukumpirmahin ng \(agency) ang eksaktong halaga mo."
        }
    }
    ...
    static let ineligibleHeadline = CivicaText(
        ...
        tl: "Lampas sa tinatayang limitasyon ng SNAP"
    )
    static let ineligibleContextGrossOver = CivicaText(
        ...
        tl: "Mukhang mas mataas ang kita mo kaysa sa pederal na limitasyon ng SNAP para sa laki ng sambahayan mo."
    )
    static let ineligibleContextNetOver = CivicaText(
        ...
        tl: "Pagkatapos ng SNAP deductions, mas mataas pa rin ang net na kita mo kaysa sa limitasyon ng SNAP."
    )
    static let ineligibleContextBelowMin = CivicaText(
        ...
        tl: "Base sa mga numerong ito, walang benepisyong lumalabas sa pormula. Puwedeng magbago ito kapag inayos ang renta o kita."
    )
    static let bbceSoftNote = CivicaText(
        ...
        tl: "Maraming estado ang gumagamit ng Broad-Based Categorical Eligibility (BBCE) na mas mataas ang limitasyon sa kita — puwede pa ring sulit na mag-apply."
    )
    ...
    static func applyCTA(stateCode: String?, language: CivicaLanguage) -> String {
        guard SNAPComplianceCopyRegistry.approvedEnglish(for: "estimator_apply_cta") != nil else {
            if language == .tagalog { return "Mag-apply para sa SNAP" }
        ...
        case .tagalog:
            return portal.isEmpty ? "Mag-apply para sa SNAP benefits" : "Mag-apply sa \(portal)"
        }
    }
    static let seeTheMathLink = CivicaText(
        ...
        tl: "Tingnan kung paano namin ito kinalkula"
    )
    ...
    static let entryCardSubtitle = CivicaText(
        ...
        tl: "Limang tanong. Tingnan ang buwanang halaga mo bago ka mag-apply."
    )
    ...
    static func entryCardSubtitle(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        guard let approvedEN = SNAPComplianceCopyRegistry.approvedEnglish(for: "estimator_entry_subtitle"),
            ...
            if language == .tagalog {
                return "Limang tanong. Tingnan ang buwanang halaga mo bago ka mag-apply."
            }
        ...
        let agency = SNAPAgencyDirectory.agencyFullName(for: stateCode, language: language)
        let template = (language == .english || language == .tagalog) ? approvedEN : approvedES
        return template
    ...
    static let staleRulesHeadline = CivicaText(
        ...
        tl: "Maaaring luma na ang datos ng benepisyo"
    )
    static let staleRulesBody = CivicaText(
        ...
        tl: "Huling na-update ang mga panuntunan ng SNAP ng Civica para sa kasalukuyang fiscal year at maaaring hindi pa kasama ang bagong pederal o pang-estadong pagbabago. Gamitin ang tantya bilang pangkalahatang gabay at kumpirmahin sa ahensya ng iyong estado."
    )
    ...
    static func federalEstimateNote(stateCode: String?, language: CivicaLanguage) -> String {
        ...
        case .tagalog:
            return "Tantya ng CalFresh. Ang opisyal na desisyon ng \(agency) ay base sa buo mong case file at maaaring mag-iba."
        }
    }
    ...
    static let citationFooter = CivicaText(
        ...
        tl: "Mga datos ng FY26 · USDA FNS COLA epektibo simula Oktubre 1, 2025"
    )
    ...
    static let disclaimerFooter = CivicaText(
        ...
        tl: "Tantya ito ng Civica. Ang ahensya ng iyong estado ang gumagawa ng pinal na desisyon."
    )
