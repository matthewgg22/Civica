...
enum CivicaAIBadgeStrings {
    ...
    static let accessibilityLabel = CivicaText(
        ...
        zh: "AI 辅助功能",
        vi: "Tính năng dùng AI",
        tl: "Feature na gumagamit ng AI"
    )
    static let accessibilityHintTappable = CivicaText(
        ...
        tl: "Tungkol sa AI sa feature na ito"
    )
}
...
enum CivicaAITransparencyStrings {
    ...
    static let navTitle = CivicaText(
        ...
        tl: "Paano tumutulong ang AI sa Civica"
    )
    static let intro = CivicaText(
        ...
        vi: "Civica dùng AI ở một vài chỗ cụ thể để giảm bớt gánh nặng giấy tờ khi xin trợ cấp. Đây là chính xác những chỗ chúng tôi dùng, và những chỗ chúng tôi không dùng.",
        tl: "Gumagamit ang Civica ng AI sa ilang partikular na lugar para mabawasan ang dami ng papeles sa pagkuha ng benepisyo. Eto kung saan eksakto, at kung saan hindi namin ginagamit."
    )
    ...
    static let useTitle = CivicaText(
        ...
        tl: "Para saan namin ginagamit ang AI"
    )
    ...
    static let usePracticeBody = CivicaText(
        ...
        vi: "Một mô phỏng nhân viên xã hội chạy bằng Claude, hỏi đúng những câu mà một người phỏng vấn thật sẽ hỏi, để bạn tập trước khi gọi.",
        tl: "Isang caseworker simulation na pinapagana ng Claude na nagtatanong ng parehong mga tanong na itatanong ng totoong interviewer, para makapag-ensayo ka bago ang tawag."
    )
    static let useDocumentsTitle = CivicaText(
        ...
        tl: "Pagkuha ng impormasyon sa dokumento"
    )
    static let useDocumentsBody = CivicaText(
        ...
        vi: "AI ngay trên máy đọc phiếu lương và giấy tờ tùy thân để điền các ô cho bạn. Bạn xác nhận từng giá trị trước khi nó được dùng.",
        tl: "Ang AI sa loob mismo ng device ang bumabasa ng paystub at ID para punan ang mga field para sa iyo. Iko-confirm mo ang bawat halaga bago ito gamitin."
    )
    static let useVoiceTitle = CivicaText(
        "Voice intake transcription",
        es: "Transcripción de entrada por voz",
        zh: "语音录入与转写",
        vi: "Ghi âm và chuyển lời nói thành văn bản",
        tl: "Pag-transcribe ng voice intake"
    )
    static let useVoiceBody = CivicaText(
        ...
        vi: "Chuyển lời nói thành văn bản cộng với trích xuất có cấu trúc cho phép bạn nói ra tình huống của mình thay vì gõ chữ.",
        tl: "Pinapayagan ka ng speech-to-text kasama ang structured na pagkuha na ilarawan ang sitwasyon mo nang pasalita sa halip na mag-type."
    )
    ...
    static let useDraftsBody = CivicaText(
        ...
        vi: "Điền sẵn các bản nháp câu trả lời để bạn chỉnh sửa trước khi chúng đi đâu đó. Không có gì được gửi đi tự động.",
        tl: "Pina-prefill ang mga draft ng sagot na maaari mong i-edit bago ito mapunta kahit saan. Walang awtomatikong naisa-submit."
    )
    ...
    static let dataTitle = CivicaText(
        ...
        zh: "你的数据去了哪里",
        vi: "Dữ liệu của bạn đi đâu",
        tl: "Saan napupunta ang data mo"
    )
    static let dataOnDevice = CivicaText(
        ...
        vi: "Ngay trên máy: bản quét giấy tờ và phần ghi âm không bao giờ rời khỏi điện thoại của bạn ở bước trích xuất.",
        tl: "Sa loob ng device: ang mga scan ng dokumento at voice intake ay hindi kailanman umaalis sa telepono mo para sa hakbang ng pagkuha."
    )
    static let dataBackend = CivicaText(
        ...
        vi: "Supabase Edge Functions: các buổi tập với Huấn luyện viên Phỏng vấn dùng Claude Sonnet qua backend của chúng tôi. Bản ghi được lưu lại để bạn xem và sẽ được xóa khi bạn yêu cầu.",
        tl: "Supabase Edge Functions: ang mga practice session ng Interview Coach ay gumagamit ng Claude Sonnet sa pamamagitan ng aming backend. Ang mga transcript ay iniimbak para sa pag-review mo at binubura kapag hiniling."
    )
    static let dataNoTraining = CivicaText(
        ...
        tl: "Hindi kailanman ginagamit para sa pag-train ng modelo."
    )
    ...
    static let neverTitle = CivicaText(
        ...
        tl: "Para saan HINDI namin ginagamit ang AI"
    )
    ...
    static let neverLegalBody = CivicaText(
        ...
        vi: "Không có nội dung nào ở đây là tư vấn pháp lý. Để có câu trả lời có giá trị ràng buộc, hãy liên hệ một tổ chức trợ giúp pháp lý.",
        tl: "Wala dito ang legal na payo. Para sa mga sagot na may bisa, kumausap ng isang legal aid na organisasyon."
    )
    static let neverEligibilityTitle = CivicaText(
        "Eligibility determinations",
        es: "Determinaciones de elegibilidad",
        zh: "资格判定",
        vi: "Xác định điều kiện hưởng trợ cấp",
        tl: "Pagtukoy ng pagiging kwalipikado"
    )
    static let neverEligibilityBody = CivicaText(
        ...
        vi: "Ước tính điều kiện hưởng trợ cấp mà bạn thấy là do bộ máy quy tắc SNAP có kết quả cố định của chúng tôi tạo ra — không phải AI.",
        tl: "Ang aming deterministic na SNAP rules engine — hindi ang AI — ang gumagawa ng tantya ng pagiging kwalipikado na nakikita mo."
    )
    static let neverSubmissionTitle = CivicaText(
        "Submission to government",
        es: "Envío al gobierno",
        zh: "向政府提交",
        vi: "Nộp hồ sơ cho chính phủ",
        tl: "Pagsusumite sa gobyerno"
    )
    static let neverSubmissionBody = CivicaText(
        ...
        vi: "Người thật sẽ xem lại hồ sơ của bạn trước khi chuyển cho một người hỗ trợ hoặc hệ thống của county.",
        tl: "May totoong tao na nag-re-review ng iyong packet bago ito maipasa sa isang navigator o sistema ng county."
    )
    ...
    static let privacyLink = CivicaText(
        ...
        zh: "阅读完整的隐私声明",
        vi: "Đọc toàn bộ thông báo quyền riêng tư",
        tl: "Basahin ang buong abiso sa privacy"
    )
