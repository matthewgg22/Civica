...
final class SNAPApplicationViewModel: ObservableObject {
    ...
    /// Used by tests and legacy call sites to advance the flow to the confirmation step.
    /// Server-side persistence is handled by CivicaSNAPFlowView.runGeneratePacket().
