...
const input = "w-full border border-input rounded-[3px] px-3 py-2 text-[13px] bg-paper focus:outline-none focus:border-pine focus:ring-2 focus:ring-pine/30 transition-colors mt-1";
