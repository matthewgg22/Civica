 ...
 * Uses --color-warning (DESIGN.md §2.2 warningAmber, #B5511E) — the
 * dedicated warning token. Distinct from --color-amber (#C9922A) which
 * is the positive-outcome signal (eligibility, deposit amounts).
 */
