...
const C: Record<Locale, {
  ...
  en: { open: "Ask Mae", title: "Hi, I'm Mae", intro: "I help you through the SNAP application. Ask me what a question means or what to put.", soon: "Live chat is coming to the web soon. For now, a navigator can help you in person or by phone.", human: "Talk to a navigator", close: "Close" },
  es: { open: "Pregúntale a Mae", title: "Hola, soy Mae", intro: "Te ayudo con la solicitud de SNAP. Pregúntame qué significa una pregunta o qué poner.", soon: "El chat en vivo llegará pronto a la web. Por ahora, un navigator puede ayudarte en persona o por teléfono.", human: "Habla con un navigator", close: "Cerrar" },
  zh: { open: "询问 Mae", title: "你好,我是 Mae", intro: "我帮助你完成 SNAP 申请。问我某个问题的含义或该填什么。", soon: "网页版实时聊天即将推出。目前,导航员可以当面或电话为你提供帮助。", human: "联系导航员", close: "关闭" },
  vi: { open: "Hỏi Mae", title: "Chào, tôi là Mae", intro: "Tôi giúp bạn hoàn thành đơn SNAP. Hỏi tôi ý nghĩa của câu hỏi hoặc nên điền gì.", soon: "Trò chuyện trực tiếp sẽ sớm có trên web. Hiện tại, nhân viên hỗ trợ có thể giúp bạn trực tiếp hoặc qua điện thoại.", human: "Nói chuyện với nhân viên hỗ trợ", close: "Đóng" },
  tl: { open: "Tanungin si Mae", title: "Kumusta, ako si Mae", intro: "Tinutulungan kita sa aplikasyon ng SNAP. Tanungin mo ako kung ano ang ibig sabihin ng tanong o ano ang ilalagay.", soon: "Malapit nang dumating ang live chat sa web. Sa ngayon, may navigator na pwedeng tumulong sa iyo nang personal o sa telepono.", human: "Makipag-usap sa navigator", close: "Isara" },
};
