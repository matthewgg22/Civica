...
export const welcomeStrings = {
  ...
  zh: {
    ...
    home_hero_body: "Civica 为你解读加州 CalFresh 规则，并在 10 分钟内引导你完成申请。不需要最低收入。",
    ...
    home_faq_a5:
      "这一条正在变化，所以我们不会给出肯定的答案。自 2022 年起，联邦“公共负担”规则不将 SNAP 计入，但国土安全部已废除该规则，自 2026 年 9 月 18 日起生效；此后官员可逐案考量福利领取情况。如果你家中有人不是美国公民，请在申请前咨询免费的移民法律援助，不要问我们，也不要问个案工作人员。",
