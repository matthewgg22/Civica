...
export const T = {
  en: {
    ...
    title: "Demeter",
    tagline: "SNAP enrollment assistance",
    ...
    sidebarAutosaved: "Saving automatically",
  ...
  es: {
    ...
    title: "Demeter",
    tagline: "Ayuda con la inscripción a SNAP",
    ...
    modeOffer: "¿Quieres que reúna tus respuestas en una solicitud esbozada mientras conversamos?",
    modeOfferEstimate: "Reunir mis respuestas",
    ...
    sidebarAutosaved: "Guardado automático",
  ...
  vi: {
    ...
    modeOffer: "Bạn có muốn tôi gom câu trả lời của bạn thành bản phác thảo đơn trong lúc trò chuyện không?",
    modeOfferEstimate: "Gom câu trả lời của tôi",
    ...
    sidebarAutosaved: "Đang tự động lưu",
  ...
  zh: {
    ...
    modeOffer: "需要我把您说的内容逐步整理成一份申请提纲吗？",
    modeOfferEstimate: "整理我的回答",
    modeOfferAsk: "只是问问",
