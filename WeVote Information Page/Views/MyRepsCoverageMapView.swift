...
// MARK: - MyRepsCoverageMapView

struct MyRepsCoverageMapView: UIViewRepresentable {
    let mapMode: MapMode
    ...
    struct InsetProxyLayout {
        let anchorX: Double
        let anchorY: Double
        let scale: Double
    }

    static let insetProxyLayoutsByStateCode: [String: InsetProxyLayout] = [
