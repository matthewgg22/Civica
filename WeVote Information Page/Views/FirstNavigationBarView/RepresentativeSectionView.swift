    ...
    private var headshotContent: some View {
        if let bundledImage {
            ...
            Image(systemName: "person.crop.circle.fill")
                .resizable()
                .scaledToFit()
                .foregroundColor(VoteNowColors.textSecondary.opacity(0.45))
        }
    }
                ...
                Image(asset)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 7, style: .continuous)
                            .stroke(VoteNowColors.ctaBlue.opacity(0.30), lineWidth: 0.9)
                    )
                    .shadow(color: VoteNowColors.textPrimary.opacity(0.22), radius: 4, x: 0, y: 2)
