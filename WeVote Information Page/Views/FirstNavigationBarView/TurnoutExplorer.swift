        ...
        VStack(alignment: .leading, spacing: CivicaSpacing.md) {
            ...
            if let summary {
                ...
                HStack(spacing: CivicaSpacing.md) {
                    ...
                    LegendKey(color: CivicaColors.ink.opacity(0.18), text: "everyone else")
                }
                ...
                VStack(alignment: .leading, spacing: CivicaSpacing.sm) {
                    HStack(alignment: .top, spacing: CivicaSpacing.sm) {
                        ...
                        MetricMiniStat(
                            ...
                            backgroundColor: CivicaColors.pinePrimary.opacity(0.12),
                            borderColor: CivicaColors.pinePrimary.opacity(0.28)
                        )
                    }
                ...
                VStack(alignment: .leading, spacing: CivicaSpacing.xs) {
                    ...
                    ForEach(Array(lines.enumerated()), id: \.offset) { index, line in
                        Text(line)
                            ...
                            .foregroundColor(index == 0 ? CivicaColors.ink : CivicaColors.graphite)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                }
            ...
            GeometryReader { geometry in
                ...
                ZStack(alignment: .leading) {
                    Capsule(style: .continuous)
                        .fill(CivicaColors.ink.opacity(0.12))
                        .frame(height: 6)
            ...
            GeometryReader { geo in
                ...
                HStack(alignment: .bottom, spacing: spacing) {
                    ForEach(Array(visibleDiagnostics.enumerated()), id: \.element.id) { offset, item in
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: CivicaRadius.control, style: .continuous)
                                .fill(inSelection ? CivicaColors.pinePrimary.opacity(0.12) : Color.clear)
                        )
                    }
                }
...
private struct ElectorateDonut: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .stroke(CivicaColors.ink.opacity(0.18), lineWidth: 18)
...
private struct TurnoutGraphPalette {
    ...
    static func palette(forTurnoutRate turnoutRatePct: Double) -> TurnoutGraphPalette {
        ...
        case ..<60:
            return TurnoutGraphPalette(
                votedColor: CivicaColors.warningAmber,
                nonvotingColor: CivicaColors.warningAmber.opacity(0.34)
            )
        case ..<70:
            return TurnoutGraphPalette(
        ...
        default:
            return TurnoutGraphPalette(
                votedColor: CivicaColors.accentTeal,
                nonvotingColor: CivicaColors.accentTeal.opacity(0.30)
            )
        }
    }
}
...
private struct MetricStat: View {
    ...
    var borderColor: Color = CivicaColors.ink.opacity(0.06)
