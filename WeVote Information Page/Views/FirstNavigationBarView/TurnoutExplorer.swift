    ...
    var body: some View {
        ...
        .background(
            ZStack {
                ...
                VoteNowColors.surfacePrimary.opacity(0.86)
            }
        )
        .overlay(
        ...
        VStack(alignment: .leading, spacing: CivicaSpacing.md) {
            ...
            if let summary {
                ...
                HStack(spacing: CivicaSpacing.md) {
                    ...
                    LegendKey(color: VoteNowColors.textPrimary.opacity(0.18), text: "everyone else")
                }
                ...
                VStack(alignment: .leading, spacing: CivicaSpacing.sm) {
                    HStack(alignment: .top, spacing: CivicaSpacing.sm) {
                        ...
                        MetricMiniStat(
                            ...
                            backgroundColor: VoteNowColors.ctaBlue.opacity(0.12),
                            borderColor: VoteNowColors.ctaBlue.opacity(0.28)
                        )
                    }
                ...
                VStack(alignment: .leading, spacing: CivicaSpacing.xs) {
                    ...
                    ForEach(Array(lines.enumerated()), id: \.offset) { index, line in
                        Text(line)
                            ...
                            .foregroundColor(index == 0 ? VoteNowColors.textPrimary : VoteNowColors.textSecondary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                }
            ...
            Text(label)
                ...
                .background(
                    RoundedRectangle(cornerRadius: 9, style: .continuous)
                        .fill(isSelected ? VoteNowColors.ctaBlue : VoteNowColors.surfacePrimary)
                )
                .overlay(
                    RoundedRectangle(cornerRadius: 9, style: .continuous)
                        .stroke(VoteNowColors.textPrimary.opacity(0.10), lineWidth: 1)
                )
        }
        .buttonStyle(.plain)
    }
            ...
            GeometryReader { geometry in
                ...
                ZStack(alignment: .leading) {
                    Capsule(style: .continuous)
                        .fill(VoteNowColors.textPrimary.opacity(0.12))
                        .frame(height: 6)
    ...
    private func thumb(at x: CGFloat, y: CGFloat, visualSize: CGFloat, touchSize: CGFloat, fillColor: Color) -> some View {
        ZStack {
            ...
            Circle()
                ...
                .shadow(color: VoteNowColors.textPrimary.opacity(0.18), radius: 3, x: 0, y: 1)
        }
            .position(x: x, y: y)
            .contentShape(Rectangle())
    }
                    ...
                    ForEach(Array(visibleDiagnostics.enumerated()), id: \.element.id) { offset, item in
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 6, style: .continuous)
                                .fill(inSelection ? VoteNowColors.ctaBlue.opacity(0.12) : Color.clear)
                        )
                    }
                }
...
private struct ElectorateDonut: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .stroke(VoteNowColors.textPrimary.opacity(0.18), lineWidth: 18)
    ...
    static func palette(forTurnoutRate turnoutRatePct: Double) -> TurnoutGraphPalette {
        ...
        case ..<40:
            return TurnoutGraphPalette(
                votedColor: VoteNowColors.ctaRed,
                nonvotingColor: VoteNowColors.ctaRed.opacity(0.34)
            )
        case ..<50:
            return TurnoutGraphPalette(
...
private struct MetricStat: View {
    ...
    let value: String
    let helper: String
    var backgroundColor: Color = VoteNowColors.surfacePrimary
    var borderColor: Color = VoteNowColors.textPrimary.opacity(0.06)
