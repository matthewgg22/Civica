...
struct IssueCallCenterView: View {
    ...
    private func draftPreviewCard(_ brief: CivicCallBrief) -> some View {
        VStack(alignment: .leading, spacing: 10) {
            Text("Draft preview for [REPRESENTATIVE]")
                .font(.subheadline.weight(.semibold))
                .foregroundColor(VoteNowColors.primaryText)
    ...
    private var civicScoreSummaryCard: some View {
        ...
        return VStack(alignment: .center, spacing: 12) {
            civicScoreHeadline(
                ...
                displayedCommunityCalls: displayedTotalCalls,
    ...
    private func civicScoreHeadline(
        ...
        VStack(alignment: .center, spacing: 4) {
            ...
            Text("\(displayedCommunityCalls.formatted(.number)) \(l("app.issue_call.score.stats.community_calls", "Community calls"))")
                .font(.subheadline.weight(.semibold))
                .foregroundColor(VoteNowColors.mutedText)
                .frame(maxWidth: .infinity, alignment: .center)
